<template>
  <div>
    <group label-width="4.5em" label-margin-right="2em" label-align="right">
      ...
      <x-input title="Reporter" v-model="value1"></x-input>
      ...
      <selector title="Hidden categories" :options="['工艺技术', '其他']" v-model="value2"></selector>
      <selector title="Hidden categories" placeholder="Placeholder" :options="['工艺技术', '其他']" v-model="value7"></selector>
      <selector title="Hidden categories" :options="['工艺技术', '其他']" v-model="value8"></selector>
      <x-input title="Hidden parts" placeholder="必填" v-model="value3"></x-input>
      ...
      <x-textarea title="details" placeholder="Please fill in the details" :show-counter="false" :rows="3"></x-textarea>
      <x-textarea placeholder="Please fill in the details" :show-counter="false" :rows="3">
        <img slot="restricted-label" style="display:inline-block;vertical-align:middle;" src="http://dn-placeholder.qbox.me/110x110/FF2D55/000" width="24" height="24">
      </x-textarea>
    </group>
    <br>
